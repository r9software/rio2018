...
<html>
    <head>
        ...
        <meta name="twitter:title" content="¡Lo Lograste!" />
        <meta name="twitter:description" content="¡HAS SALVADO EL VIBRANT!" />
        <meta name="twitter:image" content="{{ URL::asset('media/kia.png') }}" />
        <meta property="og:url"                content="{{ URL::route("login")}}" />
        <meta property="og:type"               content="website" />
        <meta property="og:title"              content="¡Lo Lograste!" />
        <meta property="og:description"        content="¡HAS SALVADO EL VIBRANT!" />
        <meta property="og:image"              content="{{ URL::asset('media/kia.png') }}" />
            ...
            <div id="home-container" class="section-container">
                ...
                <div id="home-social-btns">
                    ...
                    <div id="fb-button" class="btn">
                        <a href="#">
                            <img src="{{ URL::asset('media/social/fb.png') }}" alt="Ingresar con Facebook" class="btn-img"></a>
                    </div>
                    <div id="tw-button" class="btn">
                        <a href="https://twitter.com/intent/tweet?url={{ URL::route("login")}}&text=¡Lo Lograste!"   data-url="{{ URL::route("login")}}">
                            <img src="{{ URL::asset('media/social/tw.png') }}" alt="Ingresar con Twitter" class="btn-img"></a>
                    </div>
                </div>
